<div class="modal fade" id="baja-administrativo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Baja del Administrativo</h5>
      ...
      <div class="modal-body">
        <div class="row border-bottom" style="padding-bottom: 15px;">
          <div class="col-md">
          <label>Matricula a dar de baja: </label>
          </div>
          <div class="col-md">
            <input class="form-control" id="modal_baja_administrativo_input_matricula" type="text" value="1">
          </div>
          <div class="col-md">
        ...
        <div class="row" style="padding-top: 10px;">
          <div class="col-md">
            <div class="info_div1">
              ...
              <input class="form-control" type="text" value="Aldo Antonio" disabled="true">
            </div>
            <div class="info_div1">
              <label for="info_nombre">Apellido Paterno: </label>
              <input class="form-control" type="text" value="Alcalá" disabled="true">
            </div>
            <div class="info_div1">
              <label for="info_nombre">Apellido Materno: </label>
              <input class="form-control" type="text" value="Alejo" disabled="true">
            </div>
          </div>
          <div class="col-md">
            <div class="info_div1">
              <label for="info_nombre">Edad: </label>
              <input class="form-control" type="text" value="27" data-mask="##0" disabled="true">
            </div>
            <div class="info_div1">
              <label for="info_nombre">Instrumento: </label>
              <select class="custom-select" id="info_instrumento" disabled="true">
            ...
            <div class="info_div1">
              ...
              <input class="form-control" type="text" value="23/04/1992" data-mask="00/00/0000" placeholder="dd/mm/aaaa" disabled="true">
            </div>
          </div>
          <div class="col-md">
            <div class="info_div1">
        ...
        <div class="row">
          <div class="col-md">
            <div class="info_div1">
              ...
              <input class="form-control" type="text" data-mask="(00) 0000 0000" value="8119776885" disabled="true">
            </div>
          </div>
          <div class="col-md">
            <div class="info_div1">
          ...
          <div class="col-md">
            <div class="info_div1">
              ...
              <input class="form-control" type="text" value="aldo.aaa1@gmail.com" disabled="true">
            </div>
          </div>
        </div>
      </div>
...
<script>
  $('#baja-administrativo').on('shown.bs.modal', function(){
    $('#modal_baja_administrativo_input_matricula').trigger('focus');
  });
</script>