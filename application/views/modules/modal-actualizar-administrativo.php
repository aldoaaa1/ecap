<div class="modal fade" id="actualizar-administrativo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Actualización de Administrativo</h5>
      ...
      <div class="modal-body">
        <div class="row border-bottom" style="padding-bottom: 15px;">
          ...
          <div class="col-md">
            <input class="form-control" type="text" id='modal_actualizar_administrativo_input_matricula' value="1">
          </div>
          <div class="col-md">
