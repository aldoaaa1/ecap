<div class="modal fade" id="baja-alumno" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Baja del Alumno</h5>
      ...
      <div class="modal-body">
        <div class="row border-bottom" style="padding-bottom: 15px;">
          ...
          <div class="col-md">
            <input class="form-control" id="modal_baja_alumno_input_matricula" type="text" value="1">
          </div>
          <div class="col-md">
...
<script>
  $('#baja-alumno').on('shown.bs.modal', function(){
    $('#modal_baja_alumno_input_matricula').trigger('focus');
  });
</script>