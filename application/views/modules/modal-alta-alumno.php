<div class="modal fade" id="alta-alumno" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Información del Alumno</h5>
        ...
        <div class="row" style="padding-top: 10px;">
          <div class="col-md">
            <div class="info_div1">
              ...
              <input class="form-control" type="text" id="modal_alta_alumno_input_nombre" placeholder="Nombre">
            </div>
            <div class="info_div1">
...
<script>
  $('#alta-alumno').on('shown.bs.modal', function(){
    $('#modal_alta_alumno_input_nombre').trigger('focus');
  });
</script>